...
// ============================================================
const BUILD_VERSION = "epl2027-v1.5";
...
function SweepstakeView({ liveResults = [] }) {
  ...
  const createRoom = async () => {
    ...
    try {
      ...
      const id = genCode();
      const roomData = {
        code, name:myName.trim() + " EPL 2026/27 Room",
    ...
    <div style={{ padding:12 }}>
      ...
      <div style={{ background:"linear-gradient(135deg,#0a1826,#0f2040)", border:`1px solid ${C.sky}40`, borderRadius:14, padding:20, textAlign:"center", marginBottom:14 }}>
        ...
        <div style={{ color:C.muted, fontSize:12, lineHeight:1.6 }}>
          Pick scores. Back your club. Outsmart your mates. The ultimate EPL season long competition.
        </div>
      </div>
    ...
    <div style={ST.container}>
      ...
      <div style={ST.shell}>
        ...
        <aside style={ST.sidebar(sidebarOpen,isMobile)}>
          ...
          <div style={ST.sideFooter}>{"© 2026 EPL Predictor | All rights reserved. | "+BUILD_VERSION}</div>
        </aside>
        ...
        <main style={ST.content}>
          ...
          <div style={{ borderTop:`1px solid ${C.border}`,padding:"16px 16px 32px",marginTop:8,background:"#070e1a" }}>
            <div style={{ fontSize:10,color:C.muted,textAlign:"center",lineHeight:1.8 }}>
              © 2026 EPL Predictor · Not for betting, it is for fun!
              Predict scores, back your club and outsmart your friends.
            </div>
          </div>
        </main>
      </div>
